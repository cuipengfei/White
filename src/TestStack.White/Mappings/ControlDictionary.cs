    ...
    public class ControlDictionary
    {
        ...
        public virtual bool IsPrimaryControl(ControlType controlType, string className, string name)
        {
            return items.Exists(controlDictionaryItem =>
            {
                ...
                bool identifiedByClassNameMatches = !className.IsNullOrWhiteSpace() && className.Contains(controlDictionaryItem.ClassName) && controlDictionaryItem.IsIdentifiedByClassName;
                bool identifiedByNameMatches = !name.IsNullOrWhiteSpace() && controlDictionaryItem.TestControlType != null && name.Equals(controlDictionaryItem.TestControlType.Name) && controlDictionaryItem.IsIdentifiedByName;
